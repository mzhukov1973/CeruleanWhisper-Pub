...
BASE_APP_NAME='cw'                              #As is - base name of the app, cordova & react apps' folders names are formed based on this variable.
...
IAM='React'                                     #Which version of the script this one is.
